...
<body>
    ...
    <div class="main-content">
        ...
        <a href="/transfers/create">Tambah Transfer Baru</a>
        <table>
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                <?php foreach ($transfers as $transfer): ?>
                    <tr>
                        ...
                        <td>
                            <a href="/transfers/edit/<?= $transfer['id']; ?>">Edit</a>
                            <form action="/transfers/delete/<?= $transfer['id']; ?>" method="post" style="display:inline;">
