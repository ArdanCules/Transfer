        ...
        <form action="/contracts/update/<?= $contract['id']; ?>" method="post">
            ...
            <select name="player_id" id="player_id" required>
                <?php foreach ($players as $player): ?>
                    <option value="<?= $player['id']; ?>" <?= $contract['player_id'] == $player['id'] ? 'selected' : ''; ?>><?= $player['name']; ?></option>
                <?php endforeach; ?>
            </select>
            ...
            <select name="team_id" id="team_id" required>
                <?php foreach ($teams as $team): ?>
                    <option value="<?= $team['id']; ?>" <?= $contract['team_id'] == $team['id'] ? 'selected' : ''; ?>><?= $team['name']; ?></option>
                <?php endforeach; ?>
            </select>
            ...
            <input type="number" name="salary" id="salary" value="<?= $contract['salary']; ?>" required>
